...
import { c as createExports } from './chunks/entrypoint_BoTgl_BC.mjs';
import { manifest } from './manifest_BUwK_q_M.mjs';
...
const _page15 = () => import('./pages/program.astro2.mjs');
const _page16 = () => import('./pages/program.astro.mjs');
...
const _args = {
    "middlewareSecret": "67643808-c38b-443f-83ff-cdaf18a8c3a2",
