    ...
    id: {
        ...
        fields: {
            ...
            options: {
                ...
                'program_select': [
                    '-- Pilih --', 'IELTS', 'SAT', 'GMAT', 'GRE', 'TOEFL', 'TOEFL iBT', 'PTE', 'IGCSE', 'TOEIC', 'GED', 'A-Level', 'AS-Level', 'O-Level', 'IB', 'LSAT', 'UTBK', 'Scholarship', 'Ausbildung', 'General English', 'Business English', 'BIPA', 'JLPT', 'HSK', 'TOPIK', 'DELF', 'TestDaF', 'Duolingo', 'Belum Tahu / Butuh Konsultasi', 'ACT'
                ],
    ...
    en: {
        ...
        fields: {
            ...
            options: {
                ...
                'program_select': [
                    '-- Select --', 'IELTS', 'SAT', 'GMAT', 'GRE', 'TOEFL', 'TOEFL iBT', 'PTE', 'IGCSE', 'TOEIC', 'GED', 'A-Level', 'AS-Level', 'O-Level', 'IB', 'LSAT', 'UTBK', 'Scholarship', 'Ausbildung', 'General English', 'Business English', 'BIPA', 'JLPT', 'HSK', 'TOPIK', 'DELF', 'TestDaF', 'Duolingo', 'Not sure / Need consultation', 'ACT'
                ],
